...
#include "d2glide_fix_corner_text_patch_1_01.hpp"
...
#include "d2glide_fix_corner_text_patch_classic_1_14a.hpp"
...
std::vector<mapi::GamePatch> Make_D2Glide_FixCornerTextPatch() {
  ...
  switch (running_game_version_id) {
    ...
    case d2::GameVersion::k1_01: {
      return Make_D2Glide_FixCornerTextPatch_1_01();
    }
    ...
    case d2::GameVersion::kClassic1_14A: {
      return Make_D2Glide_FixCornerTextPatch_Classic1_14A();
    }
