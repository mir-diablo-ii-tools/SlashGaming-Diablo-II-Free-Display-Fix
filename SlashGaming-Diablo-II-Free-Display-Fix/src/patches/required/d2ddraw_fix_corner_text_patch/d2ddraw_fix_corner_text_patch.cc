...
#include "d2ddraw_fix_corner_text_patch_1_13a_beta.hpp"
...
std::vector<mapi::GamePatch> Make_D2DDraw_FixCornerTextPatch() {
  ...
  switch (running_game_version_id) {
    ...
    case d2::GameVersion::k1_13ABeta: {
      return Make_D2DDraw_FixCornerTextPatch_1_13ABeta();
    }

    case d2::GameVersion::k1_13C: {
      return Make_D2DDraw_FixCornerTextPatch_1_13C();
    }

    case d2::GameVersion::k1_13D: {
      return Make_D2DDraw_FixCornerTextPatch_1_13D();
    }
