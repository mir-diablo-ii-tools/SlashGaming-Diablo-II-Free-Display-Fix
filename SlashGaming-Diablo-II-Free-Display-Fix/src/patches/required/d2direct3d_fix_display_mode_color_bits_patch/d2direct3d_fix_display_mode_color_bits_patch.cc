...
#include "d2direct3d_fix_display_mode_color_bits_patch_1_11b.hpp"
...
#include "d2direct3d_fix_display_mode_color_bits_patch_1_13d.hpp"
...
std::vector<mapi::GamePatch> Make_D2Direct3D_FixDisplayModeColorBitsPatch() {
  ...
  switch (running_game_version_id) {
    ...
    case d2::GameVersion::k1_11B: {
      return Make_D2Direct3D_FixDisplayModeColorBitsPatch_1_11B();
    }

    case d2::GameVersion::k1_12A:
    case d2::GameVersion::k1_13ABeta: {
      return Make_D2Direct3D_FixDisplayModeColorBitsPatch_1_12A();
    }

    case d2::GameVersion::k1_13C: {
      return Make_D2Direct3D_FixDisplayModeColorBitsPatch_1_13C();
    }
