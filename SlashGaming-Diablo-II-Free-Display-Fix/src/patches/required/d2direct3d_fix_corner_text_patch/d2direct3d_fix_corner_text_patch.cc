...
#include "d2direct3d_fix_corner_text_patch_1_10.hpp"
#include "d2direct3d_fix_corner_text_patch_1_10_beta.hpp"
#include "d2direct3d_fix_corner_text_patch_1_11.hpp"
#include "d2direct3d_fix_corner_text_patch_1_11b.hpp"
#include "d2direct3d_fix_corner_text_patch_1_12a.hpp"
#include "d2direct3d_fix_corner_text_patch_1_13a_beta.hpp"
#include "d2direct3d_fix_corner_text_patch_1_13c.hpp"
#include "d2direct3d_fix_corner_text_patch_1_13d.hpp"
...
std::vector<mapi::GamePatch> Make_D2Direct3D_FixCornerTextPatch() {
  ...
  switch (running_game_version_id) {
    ...
    case d2::GameVersion::k1_10: {
      return Make_D2Direct3D_FixCornerTextPatch_1_10();
    }

    case d2::GameVersion::k1_11: {
      return Make_D2Direct3D_FixCornerTextPatch_1_11();
    }

    case d2::GameVersion::k1_11B: {
      return Make_D2Direct3D_FixCornerTextPatch_1_11B();
    }

    case d2::GameVersion::k1_12A: {
      return Make_D2Direct3D_FixCornerTextPatch_1_12A();
    }

    case d2::GameVersion::k1_13ABeta: {
      return Make_D2Direct3D_FixCornerTextPatch_1_13ABeta();
    }

    case d2::GameVersion::k1_13C: {
      return Make_D2Direct3D_FixCornerTextPatch_1_13C();
    }
