...
#include "d2direct3d_fix_corner_text_patch.h"
...
struct D2Direct3D_FixCornerTextPatch
D2Direct3D_FixCornerTextPatch_Init(void) {
  struct D2Direct3D_FixCornerTextPatch patch;
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10: {
      ...
      *patch.patch.ptr_1_00 = D2Direct3D_FixCornerTextPatch_1_00_Init();
    ...
    case D2_GameVersion_k1_13D: {
      ...
      *patch.patch.ptr_1_11 = D2Direct3D_FixCornerTextPatch_1_11_Init();
...
void D2Direct3D_FixCornerTextPatch_Deinit(
    struct D2Direct3D_FixCornerTextPatch* patch
) {
  enum D2_GameVersion running_game_version;
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2Direct3D_FixCornerTextPatch_1_00_Deinit(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_k1_13C:
    case D2_GameVersion_k1_13D: {
      D2Direct3D_FixCornerTextPatch_1_11_Deinit(patch->patch.ptr_1_11);
...
void D2Direct3D_FixCornerTextPatch_Apply(
    struct D2Direct3D_FixCornerTextPatch* patch
) {
  enum D2_GameVersion running_game_version;
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2Direct3D_FixCornerTextPatch_1_00_Apply(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_k1_13C:
    case D2_GameVersion_k1_13D: {
      D2Direct3D_FixCornerTextPatch_1_11_Apply(patch->patch.ptr_1_11);
...
void D2Direct3D_FixCornerTextPatch_Remove(
    struct D2Direct3D_FixCornerTextPatch* patch
) {
  enum D2_GameVersion running_game_version;
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2Direct3D_FixCornerTextPatch_1_00_Remove(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_k1_13C:
    case D2_GameVersion_k1_13D: {
      D2Direct3D_FixCornerTextPatch_1_11_Remove(patch->patch.ptr_1_11);
