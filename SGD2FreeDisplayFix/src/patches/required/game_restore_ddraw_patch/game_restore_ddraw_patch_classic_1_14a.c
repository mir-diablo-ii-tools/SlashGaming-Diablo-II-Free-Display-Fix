...
void __cdecl Game_RestoreDDrawPatch_Classic1_14A_InterceptionFunc01(void);
...
static struct PatchAddressAndSize GetPatchAddressAndSize01(
  ...
  switch (game_version) {
    ...
    case D2_GameVersion_kClassic1_14C: {
      ...
      patch_address_and_size.size = 0x1E49 - 0x1E35;
...
Game_RestoreDDrawPatch_Classic1_14A_Init(void) {
  ...
  patch.patches[0] = Mapi_GamePatch_InitGameBranchPatch(
      ...
      &Game_RestoreDDrawPatch_Classic1_14A_InterceptionFunc01,
...
void Game_RestoreDDrawPatch_Classic1_14A_Deinit(
  ...
  for (i = 0;
      i < Game_RestoreDDrawPatch_Classic1_14A_kPatchesCount;
      i += 1) {
