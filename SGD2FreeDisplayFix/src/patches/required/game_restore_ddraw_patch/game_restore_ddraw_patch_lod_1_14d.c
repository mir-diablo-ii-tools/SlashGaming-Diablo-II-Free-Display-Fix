...
void __cdecl Game_RestoreDDrawPatch_Lod1_14D_InterceptionFunc01(void);
...
static struct PatchAddressAndSize GetPatchAddressAndSize01(
  ...
  switch (game_version) {
    case D2_GameVersion_kLod1_14D: {
      ...
      patch_address_and_size.size = 0x65AF - 0x659D;
...
Game_RestoreDDrawPatch_Lod1_14D_Init(void) {
  ...
  patch.patches[0] = Mapi_GamePatch_InitGameBranchPatch(
      ...
      &Game_RestoreDDrawPatch_Lod1_14D_InterceptionFunc01,
...
void Game_RestoreDDrawPatch_Lod1_14D_Deinit(
  ...
  for (i = 0;
      i < Game_RestoreDDrawPatch_Lod1_14D_kPatchesCount;
      i += 1) {
