...
void __cdecl D2DDraw_FixCornerTextPatch_1_00_InterceptionFunc01(void);

void __cdecl D2DDraw_FixCornerTextPatch_1_00_InterceptionFunc02(void);
...
static struct PatchAddressAndSize GetPatchAddressAndSize01(
  ...
  switch (game_version) {
    ...
    case D2_GameVersion_k1_03: {
      ...
      patch_address_and_size.size = 0x4118 - 0x4107;
    ...
    case D2_GameVersion_k1_07Beta: {
      ...
      patch_address_and_size.size = 0x3358 - 0x3347;
    ...
    case D2_GameVersion_k1_09D: {
      ...
      patch_address_and_size.size = 0x3368 - 0x3357;
    ...
    case D2_GameVersion_k1_10SBeta: {
      ...
      patch_address_and_size.size = 0x3308 - 0x32F7;
    ...
    case D2_GameVersion_k1_10: {
      ...
      patch_address_and_size.size = 0x32F8 - 0x32E7;
...
static struct PatchAddressAndSize GetPatchAddressAndSize02(
  ...
  switch (game_version) {
    ...
    case D2_GameVersion_k1_03: {
      ...
      patch_address_and_size.size = 0x4158 - 0x4144;
    ...
    case D2_GameVersion_k1_07Beta: {
      ...
      patch_address_and_size.size = 0x3398 - 0x3384;
    ...
    case D2_GameVersion_k1_09D: {
      ...
      patch_address_and_size.size = 0x33A8 - 0x3394;
    ...
    case D2_GameVersion_k1_10SBeta: {
      ...
      patch_address_and_size.size = 0x3348 - 0x3334;
    ...
    case D2_GameVersion_k1_10: {
      ...
      patch_address_and_size.size = 0x3338 - 0x3324;
...
struct D2DDraw_FixCornerTextPatch_1_00
D2DDraw_FixCornerTextPatch_1_00_Init(void) {
  struct D2DDraw_FixCornerTextPatch_1_00 patch;
  ...
  struct PatchAddressAndSize patch_addresses_and_sizes[
      D2DDraw_FixCornerTextPatch_1_00_kPatchesCount
  ];
  ...
  patch.patches[0] = Mapi_GamePatch_InitGameBranchPatch(
      ...
      &D2DDraw_FixCornerTextPatch_1_00_InterceptionFunc01,
  ...
  patch.patches[1] = Mapi_GamePatch_InitGameBranchPatch(
      ...
      Mapi_BranchType_kCall,
      &D2DDraw_FixCornerTextPatch_1_00_InterceptionFunc02,
...
void D2DDraw_FixCornerTextPatch_1_00_Deinit(
    struct D2DDraw_FixCornerTextPatch_1_00* patch
) {
  size_t i;

  for (i = 0; i < D2DDraw_FixCornerTextPatch_1_00_kPatchesCount; i += 1) {
    Mapi_GamePatch_Deinit(&patch->patches[i]);
  }
}

void D2DDraw_FixCornerTextPatch_1_00_Apply(
    struct D2DDraw_FixCornerTextPatch_1_00* patch
) {
  size_t i;
...
void D2DDraw_FixCornerTextPatch_1_00_Remove(
    struct D2DDraw_FixCornerTextPatch_1_00* patch
) {
  size_t i;
