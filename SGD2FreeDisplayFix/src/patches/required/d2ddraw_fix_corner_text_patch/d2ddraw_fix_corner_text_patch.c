...
#include "d2ddraw_fix_corner_text_patch.h"
...
static int IsRequirePatch(void) {
  ...
  return (video_mode == D2_VideoMode_kDirectDraw);
}
...
D2DDraw_FixCornerTextPatch_Init(void) {
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10: {
      ...
      *patch.patch.ptr_1_00 = D2DDraw_FixCornerTextPatch_1_00_Init();
    ...
    case D2_GameVersion_kLod1_14C: {
      ...
      *patch.patch.ptr_1_11 = D2DDraw_FixCornerTextPatch_1_11_Init();
    ...
    case D2_GameVersion_kLod1_14D: {
      ...
      *patch.patch.ptr_classic_1_14d =
          D2DDraw_FixCornerTextPatch_Classic1_14D_Init();
...
void D2DDraw_FixCornerTextPatch_Deinit(
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2DDraw_FixCornerTextPatch_1_00_Deinit(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_kClassic1_14C:
    case D2_GameVersion_kLod1_14C: {
      D2DDraw_FixCornerTextPatch_1_11_Deinit(patch->patch.ptr_1_11);
    ...
    case D2_GameVersion_kClassic1_14D:
    case D2_GameVersion_kLod1_14D: {
      D2DDraw_FixCornerTextPatch_Classic1_14D_Deinit(
          patch->patch.ptr_classic_1_14d
      );
...
void D2DDraw_FixCornerTextPatch_Apply(
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2DDraw_FixCornerTextPatch_1_00_Apply(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_kClassic1_14C:
    case D2_GameVersion_kLod1_14C: {
      D2DDraw_FixCornerTextPatch_1_11_Apply(patch->patch.ptr_1_11);
    ...
    case D2_GameVersion_kClassic1_14D:
    case D2_GameVersion_kLod1_14D: {
      D2DDraw_FixCornerTextPatch_Classic1_14D_Apply(
          patch->patch.ptr_classic_1_14d
      );
...
void D2DDraw_FixCornerTextPatch_Remove(
  ...
  switch (running_game_version) {
    ...
    case D2_GameVersion_k1_10SBeta:
    case D2_GameVersion_k1_10: {
      D2DDraw_FixCornerTextPatch_1_00_Remove(patch->patch.ptr_1_00);
    ...
    case D2_GameVersion_kClassic1_14C:
    case D2_GameVersion_kLod1_14C: {
      D2DDraw_FixCornerTextPatch_1_11_Remove(patch->patch.ptr_1_11);
    ...
    case D2_GameVersion_kClassic1_14D:
    case D2_GameVersion_kLod1_14D: {
      D2DDraw_FixCornerTextPatch_Classic1_14D_Remove(
          patch->patch.ptr_classic_1_14d
      );
